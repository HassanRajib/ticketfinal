          ...
          <div className="w-full px-4 py-8 bg-white dark:bg-[#0a0a0a]">
            <div className="max-w-screen-xl mx-auto md:flex md:justify-between md:items-start">
              ...
              <div className="mb-10 md:mb-0 md:w-1/4 px-4">
                ...
                <p className="text-justify">MytikitBD is a smart, fast, and user-friendly online ticketing platform designed to make ticket purchasing easier than ever for people across Bangladesh.</p>
