                    ...
                    <ul className="mb-6 md:mb-0">
                        <li className="flex">
                            ...
                            <div className="ml-4 mb-4">
                                ...
                                <p className="text-gray-600 dark:text-slate-400">House: 67/9, Suite: 7/05, Pioneer Rd, Kakrail </p>
                                <p className="text-gray-600 dark:text-slate-400">Kakrail, Dhaka-1205.</p>
                            </div>
                        </li>
                        <li className="flex">
                            <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                        ...
                        <li className="flex">
                            ...
                            <div className="ml-4 mb-4">
                                <h3 className="mb-2 text-lg font-medium leading-6 text-gray-900 dark:text-white">Working
                                    hours</h3>
                                <p className="text-gray-600 dark:text-slate-400">Sunday - Thursday: 10:00 AM - 06:00 PM </p>
