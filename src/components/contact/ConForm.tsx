          ...
          <div className="grid md:grid-cols-2">
            <div className="h-full p-6">
              <p className="mt-0 mb-12 text-lg text-gray-600 dark:text-slate-400 text-justify">
                ...
                feedback regarding our service or product. Just connect with us
                in your favorable platform and we will get back to you right
                away.
              </p>
              <ul className="mb-6 md:mb-0">
                <li className="flex">
                  ...
                  <div className="ml-4 mb-4">
                    ...
                    <p className="text-gray-600 dark:text-slate-400">
                      House: 67/9, Suite: 7/05, Pioneer Rd, Kakrail{" "}
                    </p>
                    <p className="text-gray-600 dark:text-slate-400">
                      Kakrail, Dhaka-1205.
                    </p>
                ...
                <li className="flex">
                  ...
                  <div className="ml-4 mb-4">
                    ...
                    <p className="text-gray-600 dark:text-slate-400">
                      Sunday - Thursday: 10:00 AM - 06:00 PM{" "}
                    </p>
                  </div>
                </li>
              </ul>
